 ...
 */
export const ORCHESTRIX_COMMUNITY_PRODUCTS: Record<string, IPaymentProduct> = {
  [EProductSubscriptionEnum.PRO]: {
  ...
  [EProductSubscriptionEnum.BUSINESS]: {
    ...
    name: "Orchestrix Business",
    description:
      "The earliest packaging of Business at $10 a seat a month billed annually, $12 a seat a month billed monthly for Orchestrix Cloud",
    type: "BUSINESS",
    prices: [
      {
