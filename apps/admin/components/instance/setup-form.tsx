...
// internal packages
import { API_BASE_URL, E_PASSWORD_STRENGTH } from "@orchestrix/constants";
import { Button } from "@makeplane/propel/components/button";
import { Checkbox } from "@makeplane/propel/components/checkbox";
import { Input, InputGroup } from "@makeplane/propel/components/input";
import { AuthService } from "@orchestrix/services";
import { getPasswordStrength, validatePersonName, validateCompanyName } from "@orchestrix/utils";
// components
    ...
    <>
      ...
      <div className="mt-10 flex w-full flex-grow flex-col items-center justify-center py-6">
        <div className="relative flex w-full max-w-[22.5rem] flex-col gap-6">
          <FormHeader
            heading="Setup your Orchestrix Instance"
            subHeading="Post setup you will be able to manage this Orchestrix instance."
          />
          {errorData.type &&
            errorData?.message &&
            ...
            <div className="relative flex gap-2">
              <div>
                <Checkbox
                  ...
                  aria-label="Allow Orchestrix to anonymously collect usage events"
              ...
              <label className="cursor-pointer text-13 font-medium text-tertiary" htmlFor="is_telemetry_enabled">
                Allow Orchestrix to anonymously collect usage events.{" "}
                <a
                  href=""
                  target="_blank"
