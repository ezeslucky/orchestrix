...
// types
import type { IEmailCheckData, IEmailCheckResponse } from "@orchestrix/types";
// services
import { APIService } from "../api.service";

/**
 * Service class for handling authentication-related operations for orchestrix space application
