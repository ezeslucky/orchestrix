...
To verify that all tracked Python files contain the correct copyright header for **Orchestrix Software Inc.** for the year **2023**, run this command from the repository root:
...
- **`-c "Orchestrix Software Inc."`**: sets the copyright holder.
