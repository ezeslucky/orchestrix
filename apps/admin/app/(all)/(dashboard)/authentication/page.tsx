...
import type { TInstanceConfigurationKeys, TInstanceAuthenticationModes } from "@orchestrix/types";
import { cn, resolveGeneralTheme } from "@orchestrix/utils";
// components
...
export const meta: Route.MetaFunction = () => [{ title: "Authentication Settings - Orchestrix Web" }];
