...
// imports
import { convertHTMLToMarkdown } from "@orchestrix/utils";
import type { TCustomComponentsMetaData } from "@orchestrix/utils";
      ...
      handleDOMEvents: {
        copy: (view, event) => {
          try {
            ...
            event.clipboardData?.setData("text/orchestrix-editor-html", clipboardHTML);
            return true;
          } catch (error) {
