...
// imports
import type { TIssueFilterPriorityObject, TIssuePriorities } from "@orchestrix/constants";
import { ISSUE_DISPLAY_FILTERS_BY_PAGE, ISSUE_PRIORITY_FILTERS, STATE_GROUPS } from "@orchestrix/constants";
import type {
  IGanttBlock,
...
import { EIssueLayoutTypes } from "@orchestrix/types";
// local imports
