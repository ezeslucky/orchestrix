...
import type { IPublicIssue, TIssuePublicComment, TPublicIssuesResponse } from "@orchestrix/types";
// api service
import { APIService } from "../api.service";

/**
 * Service class for managing issues within orchestrix sites application
