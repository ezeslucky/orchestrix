...
import { WEB_BASE_URL } from "@orchestrix/constants";
// internal packages
...
const helpOptions = [
  ...
  {
    name: "Report a bug",
    href: "https://github.com/ezeslucky/orchestrix/issues/new/choose",
    Icon: Github,
  },
];
        ...
        {!isSidebarCollapsed ? (
          <>
            ...
            >
              ...
              {!isSidebarCollapsed && "Redirect to Orchestrix"}
            </a>
          </>
        ) : (
          <Tooltip label="Redirect to Orchestrix" side="right">
            <a
              href={redirectionLink}
              className={`relative flex items-center gap-1 rounded-sm bg-layer-1 px-2 py-1 text-body-xs-medium whitespace-nowrap text-secondary`}
            >
