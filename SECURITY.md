...
If you have identified a security vulnerability, submit your findings to [security@orchestrix.so](mailto:security@orchestrix.so). 
...
At orchestrix, we are committed to maintaining transparent and collaborative communication throughout the vulnerability resolution process. Here's what you can expect from us:
...
We appreciate your help in ensuring the security of our platform. Your contributions are crucial to protecting our users and maintaining a secure environment. Thank you for working with us to keep orchestrix safe.