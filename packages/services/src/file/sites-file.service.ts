...
// local services
import type { TFileEntityInfo, TFileSignedURLResponse } from "@orchestrix/types";
...
/**
 * Service class for managing file operations within orchestrix sites application.
