...
import { resolveGeneralTheme } from "@orchestrix/utils";
// hooks
      ...
      <div className="flex gap-4">
        <div className="grow">
          ...
          <div className="py-2 text-13 font-medium text-tertiary">
            Instance setup done! Welcome to Orchestrix instance portal. Start your journey with by creating your first
            workspace.
          </div>
